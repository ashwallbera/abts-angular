...
@Component({
  selector: 'app-driver-update-status',
  templateUrl: './driver-update-status.component.html',
  styleUrls: ['./driver-update-status.component.scss'],
})
export class DriverUpdateStatusComponent implements OnInit {
